...
export default function AppointmentsPage() {
  ...
  const upcomingEvents = useMemo(() => {
    ...
    return sortOldestByDateTime(appointments.filter((appointment) => appointment.date >= today)).slice(0, 6);
  }, [appointments]);
        ...
        <div className="section-card">
          <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex gap-2">
              <button className="secondary-button px-3" onClick={() => shiftMonth(-1)} type="button">
                Prev
              </button>
              <button
            ...
            {calendarDays.map((day) => {
              ...
              return (
                ...
                >
                  ...
                  {eventCount > 0 ? (
                    <span className="mt-3 block rounded-full bg-luxury-gold/20 px-2 py-1 text-xs font-bold text-luxury-gold-light">
          ...
          <form className="section-card" onSubmit={submitAppointment}>
            <div className="mb-6 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-luxury-muted">Doctor, dentist, gym booking, or anything important.</p>
              </div>
            </div>
